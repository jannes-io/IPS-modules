 ...
 */
class _StrengthSheet extends \IPS\core\FrontNavigation\FrontNavigationAbstract
{
    public static function typeTitle(): string
    {
        return \IPS\Member::loggedIn()->language()->addToStack('frontnavigation_penh_strength_sheet');
    }
    ...
    {
        return \IPS\Http\Url::internal('app=penh&module=personnel', 'front', 'strengthsheet');
    }
