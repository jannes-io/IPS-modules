 ...
 */
class _Orbat extends \IPS\core\FrontNavigation\FrontNavigationAbstract
{
    public static function typeTitle(): string
    {
        return \IPS\Member::loggedIn()->language()->addToStack('frontnavigation_penh_orbat');
    }
    ...
    {
        return \IPS\Http\Url::internal('app=penh&module=personnel', 'front', 'orbat');
    }
